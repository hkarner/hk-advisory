...
export default function Home() {
  return (
    <main>
      {/* Hero */}
      <section className="bg-[#1B2E4B] text-white py-28 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/book"
              className="bg-[#6D28D9] hover:bg-[#5b21b6] text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-200"
            >
              Get in Touch
            </Link>
            <Link
              href="/services"
              className="border border-white text-white hover:bg-white hover:text-[#1B2E4B] font-semibold px-8 py-3 rounded-lg transition-colors duration-200"
            >
              See Services
            </Link>
          </div>
