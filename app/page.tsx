    ...
    <main>
      ...
      <section className="bg-white py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-[#1B2E4B] leading-tight mb-6">
            AI that actually knows your work.
          </h1>
          <p className="text-lg md:text-xl text-[#1E1B4B]/70 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/services"
              className="border border-[#6D28D9] text-[#6D28D9] hover:bg-[#EDE9FE] font-semibold px-8 py-3 rounded-lg transition-colors duration-200 inline-block"
            >
              See Services
            </Link>
          </div>
